...
import AUC from '../../assets/gradMaterial/AUC.png'; // make sure this path is correct
    ...
    <>
      <div className="regiserBack"> 
        <div className="container regiserBack mx-auto min-h-screen py-20">
          ...
          {/* Replacing Team Section with AUC Image */}
          <section className="max-w-7xl mx-auto px-4 py-12">
            <motion.img 
              src={AUC} 
              alt="AUC Logo or Team Photo" 
              className="w-full h-auto mx-auto rounded-xl shadow-xl object-contain"
