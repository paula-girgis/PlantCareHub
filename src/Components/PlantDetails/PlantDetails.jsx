            ...
            <div className='regiserBack'>
                <div className="mx-auto container row py-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                        ...
                        {/* Cause Section */}
                        <motion.div
                            className="p-6 bg-[#d4edda] bg-opacity-40 rounded-3xl shadow-2xl hover:scale-105 transform transition-all duration-500"
                        ...
                        {/* Treatment Section */}
                        <motion.div
                            className="p-6 bg-[#fff7cd] bg-opacity-40 rounded-3xl shadow-2xl hover:scale-105 transform transition-all duration-500"
                            initial={{ opacity: 0, x: 50 }}
                            animate={{ opacity: 1, x: 0 }}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mt-8">
                        {/* Symptoms Section */}
                        <motion.div
                            className="p-6 bg-[#fde8e8] bg-opacity-40 text-white rounded-3xl shadow-2xl hover:scale-105 transform transition-all duration-500"
                        ...
                        {/* Images Section */}
                        <motion.div
                            className=" bg-gray-100 bg-opacity-40 p-10 text-white rounded-3xl shadow-2xl hover:scale-105 transform transition-all duration-500"
                            initial={{ opacity: 0, y: 50 }}
                            animate={{ opacity: 1, y: 0 }}
