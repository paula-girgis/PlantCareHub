...
//         <nav className="navIn shadow-2xl bg-gray-100 rounded-full flex items-center justify-between z-50 ps-4 lg:w-auto relative">
          

//           <div className="flex items-center">
//             <img className="h-20 lg:h-20 w-full" src={plantCareLogo} alt="plantCareLogo"/>
    
//           </div>


//           {/* Toggle Button */}
//           <button className="block lg:hidden text-green-900 text-2xl ml-auto pe-6"
        ...
        <nav className="navIn shadow-2xl bg-gray-100 rounded-full flex items-center justify-between z-50 ps-4 lg:w-auto relative">
          ...
          >
            {userLogin !== null ? (
              <>
                <li className="text-center my-2">
                  <NavLink to="home" className={linkClasses} onClick={() => setIsMenuOpen(false)}>
                    Home
                  </NavLink>
                </li>
                <li className="text-center my-2">
                  <NavLink to="library" className={linkClasses} onClick={() => setIsMenuOpen(false)}>
                    Library
                  </NavLink>
                </li>
                <li className="text-center my-2">
                  <NavLink to="eviroAnalysis" className={linkClasses} onClick={() => setIsMenuOpen(false)}>
                    EviroAnalysis
                  </NavLink>
                </li>
                <li className="text-center my-2">
                  <NavLink to="floraCheck" className={linkClasses} onClick={() => setIsMenuOpen(false)}>
                    FloraCheck
                  </NavLink>
                </li>
                <li className="text-center my-2">
                  <NavLink to="chatbot" className={linkClasses} onClick={() => setIsMenuOpen(false)}>
                    Chatbot
                  </NavLink>
                </li>
                <li className="text-center my-2">
                  <NavLink to="aboutUs" className={linkClasses} onClick={() => setIsMenuOpen(false)}>
                    AboutUs
                  </NavLink>
                </li>
                <li className="text-center my-2">
                  <NavLink to="contactUs" className={linkClasses} onClick={() => setIsMenuOpen(false)}>
                    ContactUs
                  </NavLink>
                </li>
                <li
            ...
            {/* Close Button for Mobile */}
            <li
              className="absolute top-3 right-3 lg:hidden cursor-pointer"
          ...
          {userLogin !== null && (
            <div
              className="hidden lg:block cursor-pointer text-red-900 text-lg pe-6"
              onClick={LogOut}
            >
              <i className="fa-solid fa-right-from-bracket"></i>
            </div>
